...
public class Driver implements MethodInvocationFrameCreationListener{
	
	@Override
	public void methodInvocationFrameCreated(OEFrame aParentFrame, OEFrame anInvocationFrame, 
		...
		anInvocationFrame.setLocation((int) (aParentFrameLocation.getX()
				+(aParentFrameSize.getWidth()/2)),
...
//		ObjectEditor.edit(new World());
		OEFrame mainFrame = ObjectEditor.tabEdit(new World());
		mainFrame.addMethodInvocationFrameCreationListener(new Driver());
